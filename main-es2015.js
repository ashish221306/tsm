...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 10, vars: 0, consts: [[1, "text-center", "info"], [1, "container-fluid"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [_task_service__WEBPACK_IMPORTED_MODULE_6__["TaskService"]], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"],
        ...
        _pages_new_task_new_task_component__WEBPACK_IMPORTED_MODULE_8__["NewTaskComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"]] }); })();
...
class NewListComponent {
    ...
    addList(value) {
        ...
        this.taskService.createList(value).subscribe((list) => this.router.navigate(['/lists', list._id]));
    }
}
...
NewListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NewListComponent, selectors: [["app-new-list"]], decls: 10, vars: 0, consts: [[1, "centered-content"], [1, "modal-box", "form-group"], [1, "title"], ["type", "text", "placeholder", "ENter list name", 1, "form-control", "has-background-light"], ["listInput", ""], ["routerLink", "/", 1, "btn", "btn-primary"], ["type", "submit", 1, "btn", "btn-primary", 3, "click"]], template: function NewListComponent_Template(rf, ctx) { if (rf & 1) {
...
class NewTaskComponent {
    ...
    addTask(value) {
        ...
        this.taskService.createTask(this.listId, value).subscribe((task) => { this.router.navigate(['../'], { relativeTo: this.route }); console.log(task); });
    }
}
...
NewTaskComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: NewTaskComponent, selectors: [["app-new-task"]], decls: 10, vars: 0, consts: [[1, "centered-content"], [1, "modal-box", "form-group"], [1, "title"], ["type", "text", "placeholder", "ENter list name", "required", "", 1, "form-control", "has-background-light"], ["taskInput", ""], ["routerLink", "../", 1, "btn", "btn-primary"], ["type", "submit", 1, "btn", "btn-primary", 3, "click"]], template: function NewTaskComponent_Template(rf, ctx) { if (rf & 1) {
        const _r1 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](NewTaskComponent, [{
    ...
    }], function () { return [{ type: src_app_task_service__WEBPACK_IMPORTED_MODULE_1__["TaskService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }]; }, null); })();
...
function TaskViewComponent_a_6_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TaskViewComponent_a_6_Template_span_click_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r5); const list_r3 = ctx.$implicit; const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.deleteList(list_r3); });
...
function TaskViewComponent_b_12_Template(rf, ctx) { if (rf & 1) {
...
function TaskViewComponent_div_14_Template(rf, ctx) { if (rf & 1) {
    const _r8 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵgetCurrentView"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 16);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TaskViewComponent_div_14_Template_div_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const task_r6 = ctx.$implicit; const ctx_r7 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r7.onTaskClick(task_r6); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "p", 13);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](2);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "span", 14);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TaskViewComponent_div_14_Template_span_click_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r8); const task_r6 = ctx.$implicit; const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.deleteTask(task_r6); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](4, "X");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
class TaskViewComponent {
    ...
    deleteTask(task) {
        console.log(task);
        this.taskService.deleteTask(this.listId, task._id).subscribe((task) => this.tasks = this.tasks.filter(t => t._id != task._id));
    }
    deleteList(list) {
...
TaskViewComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TaskViewComponent, selectors: [["app-task-view"]], decls: 17, vars: 3, consts: [[1, "centered-content", "pd"], [1, "task-manager-container"], [1, "sidebar"], [1, "title", "has-text-primary"], [1, "list-menu"], ["class", "list-menu-item", "routerLinkActive", "is-active", 3, "routerLink", 4, "ngFor", "ngForOf"], ["routerLink", "/new-list", 1, "listbtn", "btn", "btn-primary", "btn-rounded-corner"], [1, "task-list-container"], ["style", "color: #f1f1f1;", 4, "ngIf"], [1, "taskview"], ["class", "task", 3, "complete", "click", 4, "ngFor", "ngForOf"], [1, "btn", "btn-primary", "add-button", 3, "click"], ["routerLinkActive", "is-active", 1, "list-menu-item", 3, "routerLink"], [1, "white-text"], ["title", "delete", 1, "btn-danger", "pull-right", "task-delete", "btn-rounded-corner", 3, "click"], [2, "color", "#f1f1f1"], [1, "task", 3, "click"]], template: function TaskViewComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TaskViewComponent_Template_button_click_15_listener() { return ctx.addTaskClick(); });
...
TaskService.ɵfac = function TaskService_Factory(t) { return new (t || TaskService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_web_service__WEBPACK_IMPORTED_MODULE_1__["WebService"])); };
...
module.exports = __webpack_require__(/*! F:\techaltum\angular\task-manager\frontend1\src\main.ts */"./src/main.ts");
